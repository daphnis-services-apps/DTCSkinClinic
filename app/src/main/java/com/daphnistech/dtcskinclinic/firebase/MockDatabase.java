...
public final class MockDatabase {
    ...
    public static class BigTextStyleReminderAppData extends MockNotificationData {
        ...
        private BigTextStyleReminderAppData() {
            ...
            mChannelId = "channel_appointment";
            // The user-visible name of the channel.
            mChannelName = "Appointments";
            // The user-visible description of the channel.
            mChannelDescription = "Appointments Notifications";
    ...
    public static class BigPictureStyleSocialAppData extends MockNotificationData {
        ...
        private BigPictureStyleSocialAppData() {
            ...
            mBigImage = R.drawable.advertisment;
        ...
        private MessagingStyleCommsAppData(Context context) {
            ...
            mMe =
                    new Person.Builder()
                            ...
                            .setIcon(
                                    IconCompat.createWithResource(context, R.drawable.doctor_plus))
                            .build();
            ...
            Person participant2 =
                    new Person.Builder()
                            ...
                            .setIcon(IconCompat.createWithResource(context, R.drawable.doctor_plus))
                            .build();
            ...
            mMessages.add(
                    ...
                    new MessagingStyle.Message("", 1528490641998l, participant1)
                            .setData("image/png", resourceToUri(context, R.drawable.advertisment)));
